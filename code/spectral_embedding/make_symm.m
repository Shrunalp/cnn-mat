function [X, L, M] = make_symm(n, TOL)
% make_symm finds sets of coefficients that make the hyperspherical harmonic
% expansion invariant to the specified point symmetry group generators. These
% can then be interpreted as defining a compact basis for an orientation
% distribution obeying the required symmetry, namely, the symmetrized
% hyperspherical harmonics. 
% 
% The difference with make_symm_pq is in the way the eigenspaces are
% combined. The less formal procedure followed here considers only the action
% of each irrep of SO(4) on the subspace left over by the previous generators. 
% This is much faster, but does not obviously hold in general.
% 
% Inputs:
